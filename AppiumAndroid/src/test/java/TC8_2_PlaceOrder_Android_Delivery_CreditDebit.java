...
public class TC8_2_PlaceOrder_Android_Delivery_CreditDebit extends AndroidSetup {
	...
	@Test (priority = 1, dataProvider = "loginData", dataProviderClass = ExcelDataSupllier.class)
	  public void LoginFieldsTest_Delivery_CreditDebit(String email, String password ) throws Exception{
	  ...
	  public void OrderConfirmTest() throws Exception{
		  ...
		  if (errorcounter > 0)
		  {
			  markTestStatus("failed", "an error an occurred on Place Order > Delivery Credit Debit method Module test, Please see logs for details", driver);
		  }
		  else
		  {
			  markTestStatus("passed", "Place Order > Delivery Credit Debit method Module Successful", driver);
		  }
	  }
