...
public class TC7_2_PlaceOrder_Android_InStore_CreditDebit extends AndroidSetup {
   ...
   public void LoginFieldsTest_InStore_Credit_Debit(String email, String password) throws Exception {
   ...
   public void CartCleanUpTest() throws Exception {
      ...
      if (errorcounter > 0) {
         markTestStatus("failed", "an error an occurred on Place Order > In store Credit/Debit method Module test, Please see logs for details",
               driver);
      } else {
         markTestStatus("passed", "Place Order > In store Credit/Debit method Module Successful", driver);
      }
   }
