...
public class TC7_1_PlaceOrder_Android_InStore_InStorePayment extends AndroidSetup {
   ...
   public void TC7_1_PlaceOrder_Android_InStore_InStorePayment(String email, String password) throws Exception {
   ...
   public void PlaceOrderTest() throws Exception {
      ...
      if (errorcounter > 0) {
         markTestStatus("failed", "an error an occurred on Place Order > In store 'In store payment' method Module test, Please see logs for details",
               driver);
      } else {
         markTestStatus("passed", "Place Order > In store 'In store payment' method Module Successful", driver);
      }
   }
