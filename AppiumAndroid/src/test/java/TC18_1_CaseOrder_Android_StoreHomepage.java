...
public class TC18_1_CaseOrder_Android_StoreHomepage extends AndroidSetup {
   int errorcounter = 0;
   ...
   private void errorChecker() {
      if (errorcounter > 0) {
         markTestStatus("failed", "Add to cart > Homepage > Case Order, Please see logs for details", driver);
      } else {
         markTestStatus("passed", "Add to cart > Homepage > Case Order > Successful", driver);
      }
   }
