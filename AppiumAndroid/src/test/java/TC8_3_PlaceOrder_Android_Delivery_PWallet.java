...
public class TC8_3_PlaceOrder_Android_Delivery_PWallet extends AndroidSetup {
	...
	@Test (priority = 1, dataProvider = "loginData", dataProviderClass = ExcelDataSupllier.class)
	  public void LoginFieldsTest_Delivery_Pwallet(String email, String password ) throws Exception{
	  ...
	  public void TapCartButtonTest() throws Exception {
			...
			try {
				...
				try {
					AndroidElement MakatiAddress = (AndroidElement) new WebDriverWait(driver, 30).until(ExpectedConditions
							.visibilityOfElementLocated(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()"
									+ ".resourceId(\"com.android.settings:id/content\")).scrollIntoView("
									+ "new UiSelector().text(\"Test 3. This is a test address, Poblacion, Makati City, Metro Manila, 1603\"));")));
				...
				try {
					...
					if (StoreHeaderString.equals("HOME")) {
	  ...
	  public void CartQuantityFieldInputTest() throws Exception{
		  ...
		  try {
			  AndroidElement CartSubtotalElement = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("cart_subtotal_value")));		
	  ...
	  public void ScheduleChevronButtonTest() throws Exception{
		  ...
		  try {
			  ...
			  AndroidElement ScheduleFullModal = (AndroidElement) new WebDriverWait(driver, 30).until(
	  ...
	  public void PaymentChevronTest() throws Exception{
		  try {
			  ...
			  AndroidElement PaymentMethodChevronButton = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("checkout_payment_arrow")));	
	  ...
	  public void PWalletMethodTest() throws Exception{
		  try {
		      ...
		      AndroidElement PWalletOption = (AndroidElement) new WebDriverWait(driver, 30).until(
			  ...
			  Thread.sleep(2000);
				  ...
				  AndroidElement PaymentMethodElement = (AndroidElement) new WebDriverWait(driver, 30).until(
			              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("checkout_payment_info")));	
				  ...
				  driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
					...
					try {
					  ...
					  AndroidElement TopUpButton = (AndroidElement) new WebDriverWait(driver, 30).until(
				              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("dialog_top_up_balance_option_top_up")));	
					  
					  AndroidElement ChangePaymentButton = (AndroidElement) new WebDriverWait(driver, 30).until(
				              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("dialog_top_up_balance_change_option_payment_method")));	
	  ...
	  public void PlaceOrderTest() throws Exception{
		  try {
			  ...
			  AndroidElement PlaceOrderButton = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("checkout_place_order")));	
		  ...
		  try {
			  ...
			  AndroidElement CheckoutTitle = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("proceed")));	
	  ...
	  public void OrderConfirmTest() throws Exception{
		  try {
			  ...
			  AndroidElement PromoProceedButton = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("proceed")));	
		  ...
		  try {
				// Checking if successfully redirected to P-Wallet PIN page
			  AndroidElement PinTitle = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("title")));	
			  
			  if ((PinTitle.getText()).equals("P-Wallet PIN"))
			  	{
				  System.out.println("Successfully redirected to P-Wallet PIN page");
				}
			  else
			  	{
		  ...
		  try {
				// Input of P-Wallet Pin
			  AndroidElement PinField = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("wallet_enter_pin_code")));	
			  
			  PinField.click();
			  
			  PinField.sendKeys("111111");

			  driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
		  }
		  catch (Exception e) {
					markTestStatus("failed", "FAILED: P-Wallet Pin field error / not found.", driver);
					errorcounter++;
		  }
		  
		  try {
				// Clicking of Pin submit
			  AndroidElement PinSubmitButton = (AndroidElement) new WebDriverWait(driver, 30).until(
		              ExpectedConditions.visibilityOfElementLocated(MobileBy.id("wallet_enter_pin_submit")));	
			  ...
			  markTestStatus("failed", "FAILED: P-Wallet Pin submit button error / not found.", driver);
			  errorcounter++;
		  }
		  ...
		  if (errorcounter > 0)
		  {
			  markTestStatus("failed", "an error an occurred on Place Order > Delivery PWallet method Module test, Please see logs for details", driver);
		  }
		  else
		  {
			  markTestStatus("passed", "Place Order > Delivery PWallet method Module Successful", driver);
		  }
	  }
