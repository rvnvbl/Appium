...
public class TC8_1_PlaceOrder_Android_Delivery_COD extends AndroidSetup {
	...
	public void OrderConfirmTest() throws Exception {
		...
		if (errorcounter > 0) {
			markTestStatus("failed",
					"an error an occurred on Place Order > Delivery COD method Module test, Please see logs for details",
					driver);
		} else {
			markTestStatus("passed", "Place Order > Delivery COD method Module Successful", driver);
		}
	}
