...
public class TC1_0_Login_Android_LoginAsRegularUser extends AndroidSetup{
	
	/*
	 * - Elements that use the WebDriverWait waits for the element to be true on the set conditions in a set time
	 * eliminating the use of long implicit wait or thread sleep (> 10 seconds of delay).
	 * - Elements using AndroidUIAutomator as a locator is used for scrolling to the element to reduce lines of code
	 * for scrolling the screen to a specific x and y location.
	 * - Some Elements are only used for checking if the screen has successfully redirected to the next page.
	 */
