...
public class TC25_1_BillsPay_Android_NoEcBillsCategory extends AndroidSetup {
   ...
   private void MaintenaceBillspayCategories() throws InterruptedException {
      ...
      if (MaintenanceTitle.getText().equals("Category Section Maintenance")) {
   ...
   public void errorCheckr() {
      ...
      if (errorcounter > 0) {
         markTestStatus("failed", "an error an occurred on Bills Pay > No available ECbills category, Please see logs for details", driver);
      } else {
         markTestStatus("passed", "Bills Pay > No available Ecbills category Successful.", driver);
      }
   }
