...
public class TC1_1_Negative_IncorrectEmail_Login_iOS extends NegativeSetupIOS {
	...
	public void NegativeLoginEmailTest(String email, String password) throws Exception {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
...
//					.visibilityOfElementLocated(By.name("You may have entered the wrong email address or password.")));
//			
			IOSElement errorPrompt = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions
...
//			Assert.assertTrue(result.contains("Youmayhaveenteredthewrongemailaddressorpassword."));
			...
			markTestStatus("passed", "PASSED: Incorrect email test.", driver);
		} catch (Exception e) {
