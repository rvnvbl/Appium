...
public class TC8_PlaceOrder_Delivery_GCash extends SetupIOS {
	...
	public void CheckFailedCount() throws Exception {
		...
		if (failedCounter != 0) {
			markTestStatus("failed", "FAILED: Place Order for Delivery using GCash Module has error/s.", driver);
		} else {
			markTestStatus("passed", "PASSED: Place Order for Delivery using GCash Module successful.", driver);
		}
