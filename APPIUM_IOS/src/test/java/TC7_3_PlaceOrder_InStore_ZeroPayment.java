...
public class TC7_3_PlaceOrder_InStore_ZeroPayment extends SetupIOS {
   ...
   public void Verify_CartItem() throws Exception {
      ...
      try {
         ...
         IOSElement btn_cart = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "view_cart")));
         btn_cart.click();
         ...
         try {
            ...
            IOSElement btn_instore_pickup = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy
                  .name("home_btn_in_store_pickup")));
            Thread.sleep(5000);
         ...
         try {
            ...
            IOSElement searchbar = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
                  "Search for Store Branch, City or Province")));
            searchbar.click();
            driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
         ...
         try {
            IOSElement puregold_branch = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(MobileBy.name(
                  "PUREGOLD MAKATI")));
         ...
         try {
            IOSElement searchbar = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
                  "Search for product name or category")));
   ...
   public void Cart_page() throws Exception {
      ...
      try {
         ...
         IOSElement btn_okay = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name("Okay")));
         btn_okay.click();
   ...
   public void Checkout_page() throws Exception {
      ...
      try {
         ...
         Thread.sleep(5000);
         IOSElement lbl_Branch = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "Branch")));
      ...
      try {
         ...
         IOSElement lbl_contact = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "Contact Info")));
   ...
   public void Verify_Pickup_Schedule() throws Exception {
      ...
      try {
         ...
         IOSElement btn_pickup_schedule = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy
      ...
      try {
         Thread.sleep(5000);
         IOSElement btn_date = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "date_1")));
         btn_date.click();
   ...
   @Test(priority = 7, dataProvider = "inStore_method", dataProviderClass = DataProvider_Login.class)
   public void PaymentMethod_PayInStore(String InStore) throws Exception {

      // Checking if Payment Method button is visible
      try {

         IOSElement btn_paymentMethod = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(MobileBy.name(
      ...
      try {
         ...
         IOSElement btn_InStore = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               InStore)));
         btn_InStore.click();
      ...
      try {
         ...
         Thread.sleep(5000);
         // Verify if Pay In Store method is visible
         IOSElement lbl_InStore = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               InStore)));
   ...
   @Test(priority = 8, dataProvider = "AddVoucher", dataProviderClass = DataProvider_Login.class, enabled = false)
   public void Use_voucher(String voucherCode) throws Exception {
      ...
      try {
         ...
         IOSElement lbl_Subtotal = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "total")));
      ...
      // Verify if Use Voucher button is displayed
      try {

         Thread.sleep(5000);

         IOSElement btn_useVoucher = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "Use a Voucher")));
         btn_useVoucher.click();

         markTestStatus("passed", "PASSED: Use Voucher button is displayed.", driver);

         driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);

      } catch (Exception e) {
         markTestStatus("failed", "FAILED: Use Voucher button not found", driver);
         failedCounter++;
      }
      ...
      try {
         ...
         IOSElement lbl_vouchers = (IOSElement) new WebDriverWait(driver, 60).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "My Vouchers")));

         markTestStatus("passed", "PASSED: Redirected to Vouchers page.", driver);
         driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
      ...
      try {
         ...
         // verify voucher field
         // get all elements with the element class XCUIElementTypeTextField
         List<IOSElement> txt_vouchers = driver.findElementsByClassName("XCUIElementTypeTextField");

         txt_vouchers.get(0).click();
         txt_vouchers.get(0).clear();
         txt_vouchers.get(0).sendKeys(voucherCode);
         driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

         // verify redeem button
         IOSElement btn_redeem = (IOSElement) new WebDriverWait(driver, 60).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "Redeem")));
         btn_redeem.click();

         Thread.sleep(5000);

         markTestStatus("passed", "PASSED: Redeem Voucher successful.", driver);
         driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

      } catch (Exception e) {
         markTestStatus("failed", "FAILED: Redeem Voucher failed.", driver);
         failedCounter++;
      }
      ...
      try {
         ...
         // verify USE NOW button
         IOSElement btn_useNow = (IOSElement) new WebDriverWait(driver, 60).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "USE NOW")));
         btn_useNow.click();

         Thread.sleep(5000);

         markTestStatus("passed", "PASSED: Apply Voucher successful.", driver);
         driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

      } catch (Exception e) {
         markTestStatus("failed", "FAILED: Apply Voucher failed.", driver);
         failedCounter++;
      }
   ...
   public void Place_Order() throws Exception {
      ...
      try {
         ...
         IOSElement btn_placeOrder = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "Place Order")));
   ...
   public void Verify_ConfirmationPage() throws Exception {
      ...
      try {
         ...
         Thread.sleep(5000);
         IOSElement lbl_Confirmation = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "Confirmation")));
         Thread.sleep(5000);
      ...
      try {
         ...
         Thread.sleep(5000);
         IOSElement btn_MyOrders = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "My Orders")));
         btn_MyOrders.click();
         Thread.sleep(5000);
   ...
   public void Verify_OrderPage() throws Exception {
      ...
      try {
         ...
         Thread.sleep(5000);
         IOSElement lbl_Order = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "Orders")));
         Thread.sleep(5000);
   ...
   public void Remove_fromCart() throws Exception {
      ...
      try {
         ...
         IOSElement added_item = (IOSElement) new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(MobileBy.name(
               "cell_row")));
   ...
   public void CheckFailedCount() throws Exception {
      ...
      if (failedCounter != 0) {
         markTestStatus("failed", "FAILED: Place Order for In Store pickup using Zero Payment method Module has error/s.", driver);
      } else {
         markTestStatus("passed", "PASSED: Place Order for In Store pickup using Zero Payment method Module successful.", driver);
      }
