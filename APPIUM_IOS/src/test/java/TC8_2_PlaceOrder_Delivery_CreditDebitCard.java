...
public class TC8_2_PlaceOrder_Delivery_CreditDebitCard extends SetupIOS {
...
// Clicking of login button after the input of the above credentials
	...
	@Test(priority = 7, dataProvider = "CreditDebit_method", dataProviderClass = DataProvider_Login.class)
	...
	public void CheckFailedCount() throws Exception {
		...
		if (failedCounter != 0) {
			markTestStatus("failed", "FAILED: Place Order for Delivery using Credit / Debit Card Module has error/s.",
					driver);
		} else {
			markTestStatus("passed", "PASSED: Place Order for Delivery using Credit / Debit Card Module successful.",
					driver);
		}
