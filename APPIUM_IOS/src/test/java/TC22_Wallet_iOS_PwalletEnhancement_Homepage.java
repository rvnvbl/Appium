 ...
 *
 */
public class TC22_Wallet_iOS_PwalletEnhancement_Homepage extends SetupIOS {
	...
	public void CheckFailedCount() throws Exception {
		...
		if (failedCounter != 0) {
			markTestStatus("failed", "FAILED: Wallet > Pin Wallet > Homepage has error/s.", driver);
		} else {
			markTestStatus("passed", "PASSED: Wallet > Pin Wallet > Homepage successful.", driver);
		}
