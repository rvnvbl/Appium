...
public class TC7_1_PlaceOrder_InStore_InStorePayment extends SetupIOS {
	...
	public void LoginFieldsTest_Instore_InstorePayment_Method(String email, String password) throws Exception {
...
//			}
	...
	public void CheckFailedCount() throws Exception {
		...
		if (failedCounter != 0) {
			markTestStatus("failed", "FAILED: Place Order for In Store pickup using Pay In Store Module has error/s.",
					driver);
		} else {
			markTestStatus("passed", "PASSED: Place Order for In Store pickup using Pay In Store Module successful.",
					driver);
		}
