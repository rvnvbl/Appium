...
public class TC6_1_Checkout_Delivery_iOS extends SetupIOS {
...
// Clicking of login button after the input of the above credentials
	...
	public void CheckFailedCount() throws Exception {
		...
		if (failedCounter != 0) {
			markTestStatus("failed", "FAILED: Delivery Checkout Module has error/s.", driver);
		} else {
			markTestStatus("passed", "PASSED: Delivery Checkout Module successful.", driver);
		}
