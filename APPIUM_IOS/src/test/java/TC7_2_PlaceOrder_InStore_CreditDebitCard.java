...
public class TC7_2_PlaceOrder_InStore_CreditDebitCard extends SetupIOS {
	...
	public void CheckFailedCount() throws Exception {
		...
		if (failedCounter != 0) {
			markTestStatus("failed",
					"FAILED: Place Order for In Store pickup using Credit / Debit Card Module has error/s.", driver);
		} else {
			markTestStatus("passed",
					"PASSED: Place Order for In Store pickup using Credit / Debit Card Module successful.", driver);
		}
